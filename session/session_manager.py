...
This module lives inside the reusable ``gen_ai_core_lib`` package. By default,
it uses an in-memory storage backend that can be swapped for a Redis-backed
implementation in your own project if needed.
"""
...
class SessionManager:
    ...
    def __init__(
        ...
        # Initialize storage backend (defaults to in-memory implementation)
        self._storage = SessionStorage()
        
        logger.info(
            f"Initialized SessionManager with "
